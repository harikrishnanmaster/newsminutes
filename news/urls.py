...
from news.views import scrape, news_list,scrape_malayalam, login, account, register, logout, malayalam_login,english_login,english_india, malayalam_india_login
urlpatterns = [
